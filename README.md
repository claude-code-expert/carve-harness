...
> - `2026-06-11` **v1.3.4** — 경로 버그 수정: 설치 훅 명령을 `$CLAUDE_PROJECT_DIR` 절대경로로 등록(상대경로라 `No such file`로 훅 전부 실패하던 문제) + `carve update`에 기존 설치 1회 자동 교정 추가 → [기존 사용자 조치](#기존-사용자-조치-v134-훅-경로-수정)
