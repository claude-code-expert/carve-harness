...
> 단일 출처: `assets/antislop/SKILL.md` — 규칙 수정 시 두 파일을 함께 갱신한다(assets 테스트가 패리티를 강제).
...
- **타이포**: 본문 16–18px / line-height 1.5–1.7, 라벨 ≥ 11px. 헤딩 레벨 건너뛰기 금지.
- **간격**: 4/8px 그리드 — margin/padding은 `4·8·12·16·24·32·48·64`에서 고른다. 임의 값 금지.
- **대비**: 본문 텍스트/배경 4.5:1 이상(대형 텍스트 3:1).
- **카피 톤**: 사실 서술 + 수치·단위. 느낌표·최상급·"단순한 X가 아니라 Y" 문형 금지.
...
- [ ] 본문이 16px 미만이거나 대비 4.5:1 미달인가?
- [ ] 카피에 느낌표·최상급·과장 문형이 있는가?
