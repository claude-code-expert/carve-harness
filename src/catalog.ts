...
export const CATALOG: CatalogComponent[] = [
  ...
  // wave-1 fade-out: 순수 위임 shim — NL 트리거는 squad-router, 심층 리뷰는 squad-review가 담당
  { id: 'review', kind: 'skill', title: '리뷰', description: '코드 리뷰(squad-review 위임)', score: 90, core: false, optional: false, applicable: 'all', status: 'deprecated', replacedBy: 'squad-review' },
