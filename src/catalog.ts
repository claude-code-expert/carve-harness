...
export const CATALOG: CatalogComponent[] = [
  ...
  { id: 'workflow', kind: 'skill', title: '절차적 완수 워크플로', description: 'Fable5식 장기 실행 작업 규율 — 목표→분해→완료기준→가정→실행→자체검증→리스크 7단계 + 최소 출력형식·완료 게이트·에스컬레이션. iterate/sprint-contract/evaluation-criteria를 지휘.', score: 85, core: false, optional: false, applicable: 'all' },
