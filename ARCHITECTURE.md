...
✅: `carve init-claude` — CLAUDE.md 베이스라인(`.claude/CLAUDE.md`) + 언어 스택별 `.claude/rules/*`(ts/py/go/rust/java/dart/_default × 6) 생성, 루트 `CLAUDE.md` `@import` 멱등 연결. 내부 템플릿 `assets/claude-base/`.
